...
Write it to `docs/dumb/<yyyy-mm-dd>-<feature-slug>.md`. Create `docs/dumb/` if it does not exist. If a file for this feature is already there, overwrite it. No file is written at `terms`.
